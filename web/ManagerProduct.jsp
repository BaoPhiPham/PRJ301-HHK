            ...
            <div class="table-wrapper">
                <div class="table-title">
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            <a href="Add.jsp"  class="btn btn-success" ><i class="material-icons">&#xE147;</i> <span>Add New Product</span></a>
                    ...
                    <tbody>
                        <c:forEach items="${list}" var="o">
                            <tr>
                                ...
                                <td>${o.unitPrice} VND</td>
                                <td>
                                    <a href="loadProduct?productID=${o.productID}"  class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
